...
export type Anderdzi = {
  ...
  instructions: [
    ...
    {
      name: "disableStaking";
      discriminator: [233, 94, 186, 43, 163, 16, 70, 172];
      accounts: [
        {
          name: "vault";
          writable: true;
    ...
    {
      name: "enableStaking";
      discriminator: [129, 12, 67, 167, 223, 222, 169, 218];
      accounts: [
        {
          name: "vault";
          writable: true;
        ...
        {
          name: "vaultMsolAta";
          docs: ["The vault's mSOL ATA — created if it doesn't exist yet."];
          writable: true;
          pda: {
            seeds: [
              {
    ...
    {
      name: "harvestYield";
      discriminator: [28, 200, 150, 200, 69, 56, 38, 133];
      accounts: [
        {
          name: "vault";
          writable: true;
        ...
        },
        {
          ...
          docs: ["Protocol treasury's mSOL ATA. Validated: must be owned by the treasury PDA."];
          writable: true;
        },
        {
          name: "marinadeState";
    ...
    {
      name: "optInWatcher";
      discriminator: [67, 196, 213, 175, 37, 118, 124, 149];
      accounts: [
        {
          name: "vault";
          writable: true;
    ...
    {
      name: "optOutWatcher";
      discriminator: [105, 19, 154, 82, 74, 133, 166, 2];
      accounts: [
        {
          name: "vault";
          writable: true;
    ...
    },
    {
      ...
      discriminator: [102, 12, 67, 134, 142, 28, 184, 201];
      accounts: [
        {
          name: "treasury";
          writable: true;
    ...
    {
      name: "stakeDeposit";
      discriminator: [75, 168, 115, 239, 194, 115, 22, 98];
      accounts: [
        {
          name: "vault";
          writable: true;
    ...
    {
      name: "trigger";
      discriminator: [215, 172, 161, 36, 115, 157, 116, 147];
      accounts: [
        {
          name: "vault";
          writable: true;
    ...
    },
    {
      ...
      discriminator: [242, 202, 10, 84, 133, 137, 101, 12];
      accounts: [
        {
          name: "vault";
          writable: true;
    ...
    },
    {
      ...
      discriminator: [218, 168, 29, 227, 70, 149, 250, 31];
      accounts: [
        {
          name: "vault";
          writable: true;
    ...
    },
    {
      ...
      discriminator: [147, 10, 243, 120, 197, 30, 108, 98];
      accounts: [
        {
          name: "vault";
          writable: true;
